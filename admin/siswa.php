...
<body class="space-between-body">
    ...
    <div class="container container-margin mb-5 pt-2  bg-body-tertiary" id="container-wrapper">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">DataTables Siswa</h1>
            <ol class="breadcrumb">
                    ...
                    <div class="table-responsive p-3">
                        <table class="table align-items-center table-flush table-striped table-hover" id="dataTable">
                            ...
                            <tbody>
                                ...
                                $sql = mysqli_query($conn, "SELECT * FROM siswa,jurusan,kelas WHERE siswa.jurusanid=jurusan.jurusanid AND siswa.kelasid=kelas.kelasid ORDER BY kelas.namakelas ASC");
                                $no = 1;
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="edit_siswa.php?idsiswa=<?= $data['idsiswa'] ?>" class="btn btn-warning mb-1">Edit</a>
                                            <form action="hapus_siswa.php?idsiswa=<?= $data['idsiswa'] ?>" method="post" onsubmit="return confirm('Apakah kamu yakin ingin menghapus data ini?')" style="display: inline;">
