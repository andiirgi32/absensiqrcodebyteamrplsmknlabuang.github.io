    ...
    <div class="container container-margin mb-5">
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-6 col-md-9 bg-body-tertiary py-3">
                <h5 class="display-6 fw-bold text-center">Edit Siswa</h5>
                <form action="update_siswa.php" method="post" enctype="multipart/form-data">
                    <?php
                    include "koneksi.php";
                    $idsiswa = $_GET['idsiswa'];
                    $sql = mysqli_query($conn, "SELECT * FROM siswa WHERE idsiswa=$idsiswa");
                    while ($data = mysqli_fetch_array($sql)) {
                    ?>
                        <input type="text" class="form-control mb-2" id="idsiswa" name="idsiswa" placeholder="klik dan ketik disini..." value="<?= $data['idsiswa'] ?>" hidden>
                        <label for="inputFoto" style="display: block;" class="mb-3">
                            <img src="fotosiswa/<?= $data['fotosiswa'] ?>" alt="" class="foto-user-profile" id="imgFoto">
                        </label>
                        ...
                        <select name="kelasid" id="kelasid" class="form-control mb-2">
                            ...
                            ?>
                                <option value="<?= $data2['kelasid'] ?>" <?php if ($data2['kelasid'] == $data['kelasid']) {
                                                                                echo 'selected';
                                                                            } ?>><?= $data2['namakelas'] ?></option>
                            <?php
                            endwhile;
                            ?>
                        </select>
                        ...
                        <select name="jurusanid" id="jurusanid" class="form-control mb-2">
                            ...
                            while ($data2 = mysqli_fetch_array($sql2)) :
                            ?>
                                <option value="<?= $data2['jurusanid'] ?>" <?php if ($data2['jurusanid'] == $data['jurusanid']) {
                                                                                echo 'selected';
                                                                            } ?>><?= $data2['kepanjangan'] ?></option>
                            <?php
                            endwhile;
                            ?>
                        </select>
