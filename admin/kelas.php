...
<body class="space-between-body">
    ...
    <div class="container container-margin mb-5 pt-2 bg-body-tertiary" id="container-wrapper">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">DataTables Kelas</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
                <div class="card mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        ...
                        <a href="tambah_kelas.php" class="btn btn-primary">Tambah</a>
                    </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td width="150px">
                                            <a href="edit_kelas.php?kelasid=<?= $data['kelasid'] ?>" class="btn btn-warning">Edit</a>
                                            <form action="hapus_kelas.php?kelasid=<?= $data['kelasid'] ?>" method="post" onsubmit="return confirm('Apakah kamu yakin ingin menghapus data ini?')" style="display: inline;">
