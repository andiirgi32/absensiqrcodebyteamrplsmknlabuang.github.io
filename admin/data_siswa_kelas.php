...
<body class="space-between-body">
    ...
    <div class="container container-margin mb-5 pt-2  bg-body-tertiary" id="container-wrapper">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            $sql = mysqli_query($conn, "SELECT * FROM kelas where kelasid='$kelasid'");
            while ($namakelas = mysqli_fetch_array($sql)) :
            ?>
                <h1 class="h3 mb-0 text-gray-800">DataTables Siswa <?= $namakelas['namakelas'] ?></h1>
            <?php
            endwhile;
            ?>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
                <div class="card mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        ...
                        while ($namakelas = mysqli_fetch_array($sql)) :
                        ?>
                            <h6 class="m-0 font-weight-bold text-primary">DataTables Siswa <?= $namakelas['namakelas'] ?></h6>
                        <?php
                        endwhile;
                        ?>
                    </div>
                    <div class="table-responsive p-3">
                        <table class="table align-items-center table-flush table-striped table-hover" id="dataTable">
                            ...
                            <tbody>
                                <?php
                                $kelasid = $_GET['kelasid'];
                                $sql = mysqli_query($conn, "SELECT siswa.*, jurusan.*, kelas.namakelas FROM siswa INNER JOIN jurusan ON siswa.jurusanid=jurusan.jurusanid INNER JOIN kelas ON siswa.kelasid=kelas.kelasid WHERE siswa.kelasid='$kelasid' ORDER BY siswa.nama ASC");
                                $no = 1;
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $data['nama'] ?></td>
                                        <td><?= $data['nis'] ?></td>
                                        <td><img src="fotosiswa/<?= $data["fotosiswa"]; ?>" alt="<?= $data["nama"]; ?>" width="150px"></td>
