    ...
    <div class="container container-margin mb-5">
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-6 col-md-9 bg-body-tertiary py-3">
                <h5 class="display-6 fw-bold text-center">Ubah Kelas</h5>
                <form action="update_kelas.php" method="post">
                    ...
                    ?>
                        ...
                        <select name="namakelas" id="namakelas" class="form-control mb-2">
                        ...
                        <a href="kelas.php" class="btn btn-warning">Kembali</a>
                    <?php
                    }
                    ?>
                </form>
