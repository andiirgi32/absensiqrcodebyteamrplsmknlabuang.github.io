            ...
            <div class="col-xl-6 col-lg-6 col-md-9 bg-body-tertiary py-3">
                ...
                <form action="proses_siswa.php" method="post" enctype="multipart/form-data">
                    ...
                    <select name="kelasid" id="kelasid" class="form-control mb-2">
                        ...
                        ?>
                            <option value="<?= $data['kelasid'] ?>"><?= $data['namakelas'] ?></option>
                        <?php
                        }
                        ?>
                    </select>
                    ...
                    <select name="jurusanid" id="jurusanid" class="form-control mb-2">
                        ...
                        while ($data = mysqli_fetch_array($sql)) {
                        ?>
                            <option value="<?= $data['jurusanid'] ?>"><?= $data['kepanjangan'] ?></option>
                        <?php
                        }
                        ?>
                    </select>
