...
<body class="space-between-body">
    ...
    <div class="container container-margin mb-5 pt-2  bg-body-tertiary" id="container-wrapper">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">DataTables User</h1>
            <ol class="breadcrumb">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><img src="fotouser/<?= $data["foto"]; ?>" alt="<?= $data["namalengkap"]; ?>" width="150px"></td>
                                        <td><?= $data['username'] ?></td>
                                        <td><?= $data['alamat'] ?></td>
                                        <td><?= $data['email'] ?></td>
                                        <td><?= $data['role'] ?></td>
                                        <td class="text-center">
                                            <a href="edit_user.php?userid=<?= $data['userid'] ?>" class="btn btn-warning mb-1">Edit</a>
                                            <form action="hapus_user.php?userid=<?= $data['userid'] ?>" method="post" onsubmit="return confirm('Apakah kamu yakin ingin menghapus data ini?')" style="display: inline;">
