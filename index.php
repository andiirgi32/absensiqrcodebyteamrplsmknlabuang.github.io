...
WHERE absen.tanggal = '$tanggal' 
ORDER BY absen.waktu DESC LIMIT 1");
...
<body class="space-between-page">
  ...
  <nav class="navbar navbar-expand-lg bg-primary navbar-dark navbar-fixed">
    <div class="container">
      <a class="navbar-brand" href="#">QRSCANN</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="d-flex" role="search">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a href="admin/logo/logo1.jpg" class="nav-link" style="margin: 0; padding: 0;"><b>UPTD SMK Negeri Labuang</b> <img src="admin/logo/logo1.jpg" alt="" class="foto-user-profile-nav"></a>
            </li>
          </ul>
        </form>
      </div>
        ...
        <table class="table table-striped table-bordered table-hover" style="width: 1200px;">
          <thead>
            <tr>
              ...
              <th>Waktu</th>
              <th>Tanggal</th>
              <th>Keterangan</th> <!-- Kolom baru untuk keterangan -->
            </tr>
          </thead>
          <tfoot>
            <tr>
          ...
          <tbody>
            <?php while ($key = mysqli_fetch_assoc($result)) : ?>
              ...
              <tr>
                ...
                <td width="140px"><?= $key["waktu"]; ?> WITA</td>
                ...
                <td width="120px">
                  <?php
                  if ($key["keterangan"] == "Tepat Waktu") {
                  ?>
                    <b class="text-success"><?= $key['keterangan'] ?></b>
                  <?php
                  } elseif ($key["keterangan"] == "Terlambat") {
                  ?>
                    <b class="text-danger"><?= $key['keterangan'] ?></b>
                  <?php
                  } elseif ($key["keterangan"] == "Absen Cepat") {
                  ?>
                    <b class="text-warning"><?= $key['keterangan'] ?></b>
                  <?php
                  }
                  ?>
                </td>
                ...
                <div class="card-body">
                  ...
                  <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                      Pukul: <?= $semua_hari_ini['waktu'] ?> WITA
                      (
                      <?php
                      if ($semua_hari_ini["keterangan"] == "Tepat Waktu") {
                      ?>
                        <b class="text-success"><?= $semua_hari_ini['keterangan'] ?></b>
                      <?php
                      } elseif ($semua_hari_ini["keterangan"] == "Terlambat") {
                      ?>
                        <b class="text-danger"><?= $semua_hari_ini['keterangan'] ?></b>
                      <?php
                      } elseif ($semua_hari_ini["keterangan"] == "Absen Cepat") {
                      ?>
                        <b class="text-warning"><?= $semua_hari_ini['keterangan'] ?></b>
                      <?php
                      }
                      ?>
                      )
